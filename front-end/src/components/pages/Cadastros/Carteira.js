                ...
                cadastroFii.map((fii) => (
                    <div className={styles.content_iten}>
                        ...
                        <div className={styles.iten}>
                            ...
                            <p className={styles.contents_iten}>{fii.codigo}</p>
                        </div>
                        </div>
                        <div className={styles.display_block}>
                        <div className={styles.iten}>
                            <p className={styles.contents_title}>Cotas</p>
                            <p className={styles.contents_iten}>{fii.quantidade}</p>
                        </div>
                        </div>
                        <div className={styles.display_block}>
                        <div className={styles.iten}>
                            <p className={styles.contents_title}>VL.Aplicado</p>
                            <p className={styles.contents_iten}>R$ {fii.totalInvestido}</p>
                        </div>
                        </div>
                        <div className={styles.display_block}>
                        <div className={styles.iten}>
                            <p className={styles.contents_title}>P.Atual</p>
                            <p className={styles.contents_iten}>R$ {fii.cotacaoBase}</p>
                        </div>
                        </div>
                        <div className={styles.iten}>
                            <Link to={`/${fii._id}`}>
